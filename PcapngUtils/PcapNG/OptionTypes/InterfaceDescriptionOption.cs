...
namespace PcapngUtils.PcapNG.OptionTypes
{
    ...
    public sealed class InterfaceDescriptionOption : AbstractOption
    {
        ...
        public sealed class IpAddressV4
        {
            #region properties
        ...
        public sealed class IpAddressV6
        {
            #region properties  
            private readonly byte[] address;
            public string Address
        ...
        /// </summary>
        public IpAddressV4 IPv4Address
        {
            get;
            set;
        }
        ...
        /// </summary>
        public IpAddressV6 IPv6Address
        {
            get;
            set;
        }
        ...
        public InterfaceDescriptionOption(string Comment = null, string Name = null, string Description = null, IPAddress IPv4Address_v4 = null,
            IpAddressV6 IPv6Address = null, PhysicalAddress MacAddress = null, byte[] EuiAddress = null, long? Speed = null, byte? TimestampResolution = 6,
                    ...
                    try
                    {
                        switch (item.Key)
                        {
                            ...
                            case (ushort)InterfaceDescriptionOptionCode.IPv4AddressCode:                                 
                                ...
                                {
                                    option.IPv4Address = new IpAddressV4(item.Value);
                                }
                                else
                            ...
                            case (ushort)InterfaceDescriptionOptionCode.IPv6AddressCode:                                
                                ...
                                {
                                    option.IPv6Address = new IpAddressV6(item.Value);
                                }
                                else
