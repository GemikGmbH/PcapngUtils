    ...
    public sealed class NameResolutionRecordEntry 
    {
        ...
        public IPAddress IpAddr
        {
            ...
            set
            {
                ...
                Contract.Requires<ArgumentNullException>(value.AddressFamily == AddressFamily.InterNetwork || value.AddressFamily == AddressFamily.InterNetworkV6, "Invalid ip addres family");
                this.ipAddr = value;
            }
        }
        ...
        public NameResolutionRecordEntry(IPAddress IpAddr, string Description)
        {
            ...
            Contract.Requires<ArgumentNullException>(IpAddr.AddressFamily == AddressFamily.InterNetwork || IpAddr.AddressFamily == AddressFamily.InterNetworkV6, "Invalid ip addres family");
            this.ipAddr = IpAddr;
